...
const BookSection = forwardRef((props, ref) => {
  ...
  return (
    <>
      ...
      <section
        id="book-section"
        className="fixed top-[88px] left-0 right-0 bottom-0
             w-screen h-[calc(100vh-88px)]
             flex bg-gradient-to-b from-red-900 via-red-800 to-red-900
             text-white overflow-hidden"
      >
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-400 mt-20"></div>
