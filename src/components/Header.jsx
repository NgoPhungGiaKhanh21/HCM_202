        ...
        >
          ...
          >
            ...
            <g transform="translate(0, 5)">
              <path
                d="M50 20 C65 45 65 60 65 60 C65 75 50 85 50 85 C50 85 35 75 35 60 C35 45 50 20 50 20 Z"
                fill="#ffd54f"
              />
              <path
                d="M35 60 C35 45 20 35 20 35 C15 55 25 75 30 82 C35 80 35 80 35 80"
                fill="#ffd54f"
                opacity="0.9"
              />
              <path
                d="M65 60 C65 45 80 35 80 35 C85 55 75 75 70 82 C65 80 65 80 65 80"
                fill="#ffd54f"
                opacity="0.9"
              />
